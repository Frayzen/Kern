...
struct ext2_base_superblock {
	...
	u32 block_size; // the number to shift 1,024 to the left by to obtain the block size
	u32 fragment_size; // the number to shift 1,024 to the left by to obtain the fragment size
